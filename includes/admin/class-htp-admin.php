...
class HTP_Admin {
	...
	public function enqueue_admin_scripts( $hook ) {
		...
		if ( 'toplevel_page_holdthisproduct-settings' === $hook || 'holdthisproduct-settings' === $page ) {
		...
		if (
			'holdthisproduct_page_holdthisproduct-manage-reservations' === $hook
			|| 'holdthisproduct-settings_page_holdthisproduct-manage-reservations' === $hook
			|| 'holdthisproduct-manage-reservations' === $page
		) {
